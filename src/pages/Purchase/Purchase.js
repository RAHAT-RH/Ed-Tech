...
const Purchase = () => {
   ...
   const {
      ...
      fetch(`https://tech-parts.herokuapp.com/product/${_id}`).then((res) => {
         return res.json();
      })
   );
   ...
   const handleOrder = (data) => {
      ...
      fetch("https://tech-parts.herokuapp.com/order", {
         method: "POST",
         headers: {
         ...
         .then((data) => {
            if (data.insertedId) {
               ...
               fetch(
                  `https://tech-parts.herokuapp.com/product-available/${product._id}`,
                  {
                     method: "PATCH",
                     body: JSON.stringify({
